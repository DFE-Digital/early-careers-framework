      ...
      def authenticate!
        if params[:user].present?
          ...
          if result
            ...
            UserMailer.sign_in_email(email: email.downcase, full_name: user.full_name, url:, token_expiry: token_expiry.localtime.to_fs(:time)).deliver_later(queue: "priority_mailers")
