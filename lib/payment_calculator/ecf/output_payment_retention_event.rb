      ...
      def call(total_participants:, event_type:)
        {
          ...
          per_participant: output_payment_per_participant_for_event(event_type: event_type),
          subtotal: output_payment_for_event(total_participants: total_participants, event_type: event_type),
        }
      end
    end
  end
