  ...
  class ParticipantsSerializer
    ...
    class << self
      ...
      def status_name(participant_profile, delivery_partner)
        StatusTags::DeliveryPartnerParticipantStatusTag.new(participant_profile:, delivery_partner:).id
      end
    end
    ...
    attribute :status do |participant_profile, _params|
      StatusTags::DeliveryPartnerParticipantStatusTag.new(participant_profile:, delivery_partner:).label
    end
  end
end
