    ...
    module Duplicates
      class CompareController < BaseController
        def show
          ...
          @duplicate           = Duplicate.find(params[:duplicate_profile_id])
          ...
          @breadcrumbs = [
            ...
            helpers.govuk_breadcrumb_link_to(@duplicate.id, finance_ecf_duplicate_profile_compare_path(@duplicate, @participant_profile)),
          ]
        end
      end
    end
