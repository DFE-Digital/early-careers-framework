...
private
  ...
  def not_already_accepted
    ...
    errors.add(:npq_application, I18n.t("activerecord.errors.models.npq_application.attributes.lead_provider_approval_status.has_already_been_accepted")) if npq_application.accepted?
  end

  def cannot_change_from_rejected
    return if npq_application.blank?

    errors.add(:npq_application, I18n.t("activerecord.errors.models.npq_application.attributes.lead_provider_approval_status.cannot_change_from_rejected")) if npq_application.rejected?
  end
  ...
  def other_accepted_applications_with_same_course?
    errors.add(:npq_application, I18n.t("activerecord.errors.models.npq_application.attributes.lead_provider_approval_status.has_another_accepted_application")) if other_accepted_applications_with_same_course.present?
  end
