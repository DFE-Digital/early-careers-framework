  ...
  def call
    ActiveRecord::Base.transaction do
      if appropriate_body_appointed == false
        school_cohort.update!(appropriate_body_unknown: true, appropriate_body: nil)
      else
        school_cohort.update!(appropriate_body_unknown: false, appropriate_body_id:)
        clear_induction_records_matching_school_ab
      end
    end
  end
...
private
  ...
  def clear_induction_records_matching_school_ab
    school_cohort.induction_programmes
      ...
      induction_record.update!(appropriate_body: nil)
    end
  end
end
