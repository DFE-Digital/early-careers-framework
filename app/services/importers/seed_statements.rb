...
private
  ...
  def ecf_statements
    [
      ...
      { name: "March 2022",     deadline_date: Date.new(2022, 2, 28),  payment_date: Date.new(2022, 3, 25),  contract_version: "0.0.1" },
      { name: "April 2022",     deadline_date: Date.new(2022, 3, 31),  payment_date: Date.new(2022, 4, 25),  contract_version: "0.0.1" },
      { name: "May 2022",       deadline_date: Date.new(2022, 4, 30),  payment_date: Date.new(2022, 5, 25),  contract_version: "0.0.1" },
      { name: "June 2022",      deadline_date: Date.new(2022, 5, 31),  payment_date: Date.new(2022, 6, 25),  contract_version: "0.0.1" },
      { name: "July 2022",      deadline_date: Date.new(2022, 6, 30),  payment_date: Date.new(2022, 7, 25),  contract_version: "0.0.1" },
      { name: "August 2022",    deadline_date: Date.new(2022, 7, 31),  payment_date: Date.new(2022, 8, 25),  contract_version: "0.0.1" },
      { name: "September 2022", deadline_date: Date.new(2022, 8, 31),  payment_date: Date.new(2022, 9, 25),  contract_version: "0.0.1" },
