...
RSpec.describe ParticipantSerializer do
  describe "serialization" do
    ...
    context "when the participant record is withdrawn" do
      let(:mentor) { create(:mentor_participant_profile, :withdrawn_record) }
      let(:ect) { create(:ect_participant_profile, :withdrawn_record, mentor_profile: mentor.mentor_profile) }
