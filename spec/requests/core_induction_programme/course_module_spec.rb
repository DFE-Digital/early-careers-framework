...
RSpec.describe "Core Induction Programme Module", type: :request do
  ...
  let(:course_module_url) { "/core-induction-programme/#{course_module.course_year.id}/#{course_module.id}" }
  ...
  describe "when an admin user is logged in" do
    ...
    describe "GET /core-induction-programme/:years/:modules" do
    ...
    describe "GET /core-induction-programme/:years/:modules/edit" do
    ...
    describe "PUT /core-induction-programme/:years/:modules/edit" do
    ...
    describe "PUT /core-induction-programme/:years/:modules" do
