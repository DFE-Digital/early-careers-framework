...
RSpec.describe "Core Induction Programme Lesson", type: :request do
  ...
  let(:course_lesson_url) { "/core_induction_programme/#{course_lesson.course_module.course_year.id}/#{course_lesson.course_module.id}/#{course_lesson.id}" }
  ...
  describe "when an admin user is logged in" do
    ...
    describe "GET /core_induction_programme/:years/:modules/:lessons" do
    ...
    describe "PUT /core_induction_programme/:years/:modules/:lessons/edit" do
    ...
    describe "PUT /core_induction_programme/:years/:modules/:lessons" do
  ...
  describe "when a non-admin user is logged in" do
    ...
    describe "GET /core_induction_programme/:years/:modules/:lessons/edit" do
