...
RSpec.describe "Users::Registrations /school_confirmation", type: :request do
  ...
  describe "GET /induction_coordinators/registrations/confirm_school" do
    it "renders the correct template for a single school" do
      get "/induction_coordinators/registrations/confirm_school", params: { school_ids: [school.id] }
    ...
    it "renders the correct template for a multiple schools" do
      ...
      get "/induction_coordinators/registrations/confirm_school", params: { school_ids: [school.id, second_school.id] }
      expect(response).to render_template(:confirm_school)
