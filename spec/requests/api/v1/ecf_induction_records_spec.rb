...
RSpec.describe "API InductionRecords", :with_default_schedules, type: :request do
  ...
  describe "#index" do
    ...
    context "when authorized" do
      ...
      it "returns correct jsonapi content type header" do
        get "/api/v1/ecf-induction-records"
      ...
      it "returns the right number of users per page" do
        get "/api/v1/ecf-induction-records", params: { page: { per_page: 2, page: 1 } }
      ...
      it "returns different users for second page" do
        get "/api/v1/ecf-induction-records", params: { page: { per_page: 2, page: 2 } }
      ...
      it "returns users changed since a particular time, if given a changed_since parameter" do
        ...
        get "/api/v1/ecf-induction-records", params: { filter: { updated_since: 1.day.ago.iso8601 } }
      ...
      context "when filtering by email" do
        it "returns users that match" do
          ...
          get "/api/v1/ecf-induction-records", params: { filter: { email: } }
          expect(parsed_response["data"].size).to eql(1)
  ...
  describe "#create" do
    context "when authorized" do
      ...
      it "returns a 201" do
        post "/api/v1/ecf-induction-records.json", params: json
      ...
      it "creates a user record" do
        expect {
          post "/api/v1/ecf-induction-records", params: json
