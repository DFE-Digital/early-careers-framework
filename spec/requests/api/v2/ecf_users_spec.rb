...
RSpec.describe "API Users", type: :request do
  ...
  describe "#index" do
    ...
    context "when authorized" do
      ...
      it "returns the right number of users per page" do
        get "/api/v2/ecf-users", params: { page: { per_page: 2, page: 1 } }
      ...
      it "returns different users for second page" do
        get "/api/v2/ecf-users", params: { page: { per_page: 2, page: 2 } }
      ...
      context "when filtering by email" do
        it "returns users that match" do
          ...
          get "/api/v2/ecf-users", params: { filter: { email: email } }
          expect(parsed_response["data"].size).to eql(1)
  ...
  describe "#create" do
    context "when authorized" do
      ...
      it "returns a 201" do
        post "/api/v2/ecf-users.json", params: json
      ...
      it "creates a user record" do
        expect {
          post "/api/v2/ecf-users", params: json
