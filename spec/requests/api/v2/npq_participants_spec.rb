...
RSpec.describe "NPQ Participants API", type: :request do
  ...
  it_behaves_like "Feature enabled NPQ API endpoint", "GET", "/api/v2/participants/npq"
  it_behaves_like "Feature enabled NPQ API endpoint", "GET", "/api/v2/participants/npq/1234567"
  it_behaves_like "Feature enabled NPQ API endpoint", "PUT", "/api/v2/participants/npq/1234567/withdraw"
  it_behaves_like "Feature enabled NPQ API endpoint", "PUT", "/api/v2/participants/npq/1234567/defer"
  it_behaves_like "Feature enabled NPQ API endpoint", "PUT", "/api/v2/participants/npq/1234567/resume"
  it_behaves_like "Feature enabled NPQ API endpoint", "PUT", "/api/v2/participants/npq/1234567/change-schedule"
    ...
    context "when authorized" do
      ...
      describe "JSON Index API" do
        ...
        it "can return paginated data" do
          get "/api/v2/participants/npq", params: { page: { per_page: 2, page: 1 } }
          expect(parsed_response["data"].size).to eql(2)

          get "/api/v2/participants/npq", params: { page: { per_page: 2, page: 2 } }
        ...
        context "filtering" do
          ...
          context "with invalid filter of a string" do
            it "returns an error" do
              get "/api/v2/participants/npq", params: { filter: 2.days.ago.iso8601 }
      ...
      describe "JSON Participant Withdrawal" do
        ...
        let(:params) do
          { data: { attributes: { course_identifier:, reason: withdrawal_reason } } }
        end
