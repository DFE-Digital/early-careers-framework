...
RSpec.describe "NPQ Applications API", type: :request do
  ...
  describe "GET /api/v2/npq-applications" do
    ...
    context "when authorized" do
      ...
      it_behaves_like "Feature enabled NPQ API endpoint", "GET", "/api/v2/npq-applications"
      it_behaves_like "Feature enabled NPQ API endpoint", "GET", "/api/v2/npq-applications.csv"
          ...
          context "with filter[updated_at]" do
            ...
            context "with invalid filter[updated_at]" do
              it "returns a meaningful error message" do
                get "/api/v2/npq-applications", params: { filter: { updated_since: Date.current.to_s } }
  ...
  describe "GET /api/v2/npq-applications/:id" do
    ...
    context "when authorized" do
      ...
      it_behaves_like "Feature enabled NPQ API endpoint", "GET", "/api/v2/npq-applications/1234567"
  ...
  describe "POST /api/v2/npq-applications/:id/reject" do
    ...
    it_behaves_like "Feature enabled NPQ API endpoint", "POST", "/api/v2/npq-applications/1234567/reject"
  ...
  describe "POST /api/v2/npq-applications/:id/accept" do
    ...
    it_behaves_like "Feature enabled NPQ API endpoint", "POST", "/api/v2/npq-applications/1234567/accept"
  ...
  describe "PUT /api/v2/npq-applications/:id/change-funded-place" do
    ...
    it_behaves_like "Feature enabled NPQ API endpoint", "PUT", "/api/v2/npq-applications/1234567/change-funded-place"
    ...
    context "when feature flag `npq_capping` is enabled" do
      ...
      context "with an invalid request" do
        it "returns 422 for an invalid request" do
          put "/api/v2/npq-applications/#{accepted_application.id}/change-funded-place", params: { data: { type: "npq-application-change-funded-status", attributes: { funded_place: nil } } }.to_json
