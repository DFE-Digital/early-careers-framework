...
RSpec.feature "Admin managing school provision", js: true, rutabaga: false do
  scenario "Admin challenges school partnership" do
    ...
    then_i_should_be_on the_challenge_partnership_page(step: :reason)
    and_the_page_should_be_accessible
    and_percy_should_be_sent_a_snapshot_named("Admin challenge partnership page")

    when_i_select_mistake
    and_i_click_the_submit_button
    then_i_should_be_on the_challenge_partnership_page(step: :confirm)
...
private
  ...
  def the_challenge_partnership_page(step:)
    step_admin_school_challenge_partnership_cohort_path(
