...
RSpec.feature "Support Forms: change-participant-date-of-birth", type: :feature do
  ...
  scenario "User submits a support request" do
    ...
    visit "/support?subject=change-participant-date-of-birth&participant_profile_id=#{participant_profile.id}&school_id=#{school.id}"
    ...
    expect(SupportQuery.last.as_json).to include(
      "user_id" => @user.id,
      "subject" => "change-participant-date-of-birth",
