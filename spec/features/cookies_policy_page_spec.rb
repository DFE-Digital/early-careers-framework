...
RSpec.feature "Cookie policy page", type: :feature, js: true do
  ...
  scenario "Reading the cookie policy" do
    ...
    when_i_view_cookie_policy_from_start_page
  ...
  scenario "Returning from the cookie policy" do
    given_i_am_on_the_start_page
    when_i_view_cookie_policy_from_start_page
    when_i_go_back_from_cookie_policy_page
  ...
  scenario "Default cookie preferences" do
    given_i_am_on_the_start_page
    when_i_view_cookie_policy_from_start_page
    then_i_confirm_cookie_consent_is_given_from_cookie_policy_page
  end

  scenario "Consenting to the cookie policy" do
    given_i_am_on_the_cookie_policy_page

    when_i_give_cookie_consent_from_cookie_policy_page
  ...
  scenario "Not consenting to the cookie policy" do
    ...
    when_i_revoke_cookie_consent_from_cookie_policy_page

    then_i_confirm_cookie_consent_is_not_given_from_cookie_policy_page
    then_the_page_is_accessible
...
RSpec.feature "Cookie banner without JavaScript", type: :feature, js: false do
  scenario "Cookie banner is visible" do
    ...
    then_i_confirm_cookie_banner_displayed_from_start_page
  end

  scenario "Accepting cookies" do
    given_i_am_on_the_start_page

    when_i_accept_cookies_from_start_page

    then_i_am_on_the_cookie_policy_page
    and_i_confirm_cookie_consent_is_given_from_cookie_policy_page
  end

  scenario "Rejecting cookies" do
    given_i_am_on_the_start_page

    when_i_reject_cookies_from_start_page

    then_i_am_on_the_cookie_policy_page
    and_i_confirm_cookie_consent_is_not_given_from_cookie_policy_page
  end

  scenario "Viewing preferences after accepting cookies" do
    given_i_am_on_the_start_page
    and_i_accept_cookies_from_start_page
  ...
  scenario "Viewing preferences after rejecting cookies" do
    given_i_am_on_the_start_page
    and_i_reject_cookies_from_start_page
...
RSpec.feature "Cookie banner with JavaScript", type: :feature, js: true do
  ...
  scenario "Accepting cookies" do
    ...
    then_i_am_on_the_start_page
    and_i_confirm_cookie_preferences_accepted_from_start_page
  end
  scenario "Rejecting cookies" do
    given_i_am_on_the_start_page
    ...
    then_i_am_on_the_start_page
    and_i_confirm_cookie_preferences_rejected_from_start_page
  end
  ...
  scenario "Hiding the cookie banner after accepting" do
    ...
    when_i_hide_success_message_from_start_page

    then_i_confirm_cookie_banner_not_displayed_from_start_page
  end
  ...
  scenario "Changing preferences after accepting" do
    ...
    when_i_am_on_the_cookie_policy_page
    and_i_revoke_cookie_consent_from_cookie_policy_page
  ...
  scenario "Changing preferences after rejecting" do
    ...
    when_i_am_on_the_cookie_policy_page
    and_i_give_cookie_consent_from_cookie_policy_page
