...
RSpec.feature "ECT nominate SIT journey", type: :feature, js: true do
  ...
  scenario "Valid nomination link was sent" do
    ...
    and_percy_is_sent_a_snapshot_named "Choose how to continue"

    when_i_select "yes"
    click_on "Continue"
    then_i_should_be_on_the_start_nomination_page
    and_the_page_is_accessible
    and_percy_is_sent_a_snapshot_named "Start SIT nomination"

    click_on "Continue"
    then_i_should_be_on_the_nominations_full_name_page
    and_the_page_is_accessible
    and_percy_is_sent_a_snapshot_named "Add SIT name"
    ...
    and_the_page_is_accessible
    and_percy_is_sent_a_snapshot_named "Add SIT email"
    ...
    and_the_page_is_accessible
    and_percy_is_sent_a_snapshot_named "Nominate SIT completed"
  end
  ...
  scenario "Expired nomination link was sent" do
    ...
    and_the_page_is_accessible
    and_percy_is_sent_a_snapshot_named "Nominate a SIT link expired"
  end
  ...
  scenario "Nomination Link was sent for which Induction Tutor was already nominated for the same school" do
    ...
    and_the_page_is_accessible
    and_percy_is_sent_a_snapshot_named "SIT already nominated"
  end
  ...
  scenario "Nominating an induction tutor with name and email that do not match" do
    ...
    then_i_should_be_on_the_choose_how_to_continue_page
    and_the_page_is_accessible
    and_percy_is_sent_a_snapshot_named "How to continue"

    when_i_select "yes"
    click_on "Continue"
    then_i_should_be_on_the_start_nomination_page
    and_the_page_is_accessible
    and_percy_is_sent_a_snapshot_named "Start school induction tutor nomination"
    ...
    then_i_should_be_on_the_nominations_email_page
    and_the_page_is_accessible
    and_percy_is_sent_a_snapshot_named "SIT email does not match name"

    when_i_fill_in_using_an_email_that_is_already_being_used
    click_on "Continue"
    then_i_should_be_redirected_to_name_different_page
    and_the_page_is_accessible
    and_percy_is_sent_a_snapshot_named "Different name page"
    ...
    then_i_should_be_on_the_check_details_page
    and_the_page_is_accessible
    and_percy_is_sent_a_snapshot_named "Check details"

    click_on "Confirm and nominate"
    then_i_should_be_on_the_nominate_sit_success_page
    and_the_page_is_accessible
    and_percy_is_sent_a_snapshot_named "Nominate SIT success"
  end
  ...
  scenario "Nominating an induction tutor with an email already in use by another school" do
    ...
    and_the_page_is_accessible
    and_percy_is_sent_a_snapshot_named "SIT nomination - Email already in use"
