...
RSpec.describe "Manage Design Our Own training", js: true, with_feature_flags: { induction_tutor_manage_participants: "active" } do
  ...
  scenario "Change induction programme to Design Your Own" do
    ...
    and_i_am_signed_in_as_an_induction_coordinator
    when_i_see_the_program_and_click_to_change_it(program_label: "Programme No early career teachers for this cohort")
    ...
    then_i_should_see_the_design_our_own_training_success_page
    and_the_page_should_be_accessible
  end
end
