...
RSpec.describe "Manage CIP training", js: true do
  ...
  scenario "CIP Induction Mentor without materials chosen" do
    ...
    then_percy_is_sent_a_snapshot_named "CIP induction dashboard without materials"
    ...
    then_the_page_is_accessible
    then_percy_is_sent_a_snapshot_named "CIP programme info"
  end
  ...
  scenario "CIP Induction Mentor with materials chosen" do
    ...
    then_the_page_is_accessible
    then_percy_is_sent_a_snapshot_named "Course choice"
    ...
    then_the_page_is_accessible
    then_percy_is_sent_a_snapshot_named "CIP induction dashboard with materials"
  end
