...
RSpec.xdescribe "Manage FIP partnered participants with no change of circumstances", js: true, with_feature_flags: { eligibility_notifications: "active" } do
...
RSpec.xdescribe "Manage FIP partnered participants with change of circumstances", js: true, with_feature_flags: { eligibility_notifications: "active", change_of_circumstances: "active" } do
  include ManageTrainingSteps
