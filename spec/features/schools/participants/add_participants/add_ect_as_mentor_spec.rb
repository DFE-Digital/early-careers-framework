...
RSpec.describe "Add ECT as mentor", js: true, mid_cohort: true do
  ...
  scenario "Induction tutor tries to add an ECT that's a mentor in another school inside auto assignment period" do
  ...
  scenario "Induction tutor tries to add an ECT that's a mentor in another school outside auto assignment period for summer" do
  ...
  scenario "Induction tutor tries to add an ECT that's a mentor in another school outside auto assignment period for next academic year" do
    outside_auto_assignment_window do
      when_i_navigate_to_mentors_dashboard
      when_i_click_to_add_a_new_mentor
      then_i_should_be_on_the_who_to_add_page
      ...
      when_i_choose_autumn_term_this_cohort
      when_i_click_on_continue
  ...
  scenario "Induction tutor tries to add an ECT that's a mentor in another school inside registration period" do
