...
RSpec.describe "SIT adding mentor inside registration period", js: true do
  include ManageTrainingSteps

  scenario "when training setup is complete" do
  ...
  scenario "when training setup is needed" do
    inside_registration_window do
      given_there_is_a_school_that_has_chosen_cip
      given_there_is_a_school_that_has_chosen_fip_and_needs_training_setup
      set_participant_data
      set_dqt_validation_result
