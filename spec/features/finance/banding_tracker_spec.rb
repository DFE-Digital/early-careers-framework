...
RSpec.feature "Banding tracker", type: :feature, js: true do
  ...
  it "displays the distribution of declaration by band, retention type and declaration state" do
    ...
    expect(page).to have_css("tbody tr:nth-child(2) td:nth-child(2)", text: "15")
    expect(page).to have_css("tbody tr:nth-child(2) td:nth-child(3)", text: "5")
    expect(page).to have_css("tbody tr:nth-child(2) td:nth-child(4)", text: "0")
    expect(page).to have_css("tbody tr:nth-child(2) td:nth-child(5)", text: "0")
    expect(page).to have_css("tbody tr:nth-child(2) td:nth-child(6)", text: "0")
    ...
    expect(page).to have_css("tbody tr:nth-child(3) td:nth-child(3)", text: "15")
    expect(page).to have_css("tbody tr:nth-child(3) td:nth-child(4)", text: "5")
    ...
    expect(page).to have_css("tbody tr:nth-child(4) td:nth-child(2)", text: "0")
    expect(page).to have_css("tbody tr:nth-child(4) td:nth-child(3)", text: "0")
    expect(page).to have_css("tbody tr:nth-child(4) td:nth-child(4)", text: "8")
    expect(page).to have_css("tbody tr:nth-child(4) td:nth-child(5)", text: "8")
    expect(page).to have_css("tbody tr:nth-child(4) td:nth-child(6)", text: "4")
    ...
    expect(page).to have_css("tbody tr:nth-child(5) td:nth-child(2)", text: "0")
    ...
    expect(page).to have_css("tbody tr:nth-child(5) td:nth-child(6)", text: "2")
    expect(page).to have_css("tbody tr:nth-child(5) td:nth-child(7)", text: "2")
    ...
    expect(page).to have_css("tbody tr:nth-child(7) td:nth-child(2)", text: "15")
    expect(page).to have_css("tbody tr:nth-child(7) td:nth-child(3)", text: "5")
    expect(page).to have_css("tbody tr:nth-child(7) td:nth-child(4)", text: "0")
    expect(page).to have_css("tbody tr:nth-child(7) td:nth-child(5)", text: "0")
    expect(page).to have_css("tbody tr:nth-child(7) td:nth-child(6)", text: "0")
    ...
    expect(page).to have_css("tbody tr:nth-child(8) td:nth-child(3)", text: "15")
    expect(page).to have_css("tbody tr:nth-child(8) td:nth-child(4)", text: "5")
    ...
    expect(page).to have_css("tbody tr:nth-child(9) td:nth-child(2)", text: "0")
    expect(page).to have_css("tbody tr:nth-child(9) td:nth-child(3)", text: "0")
    expect(page).to have_css("tbody tr:nth-child(9) td:nth-child(4)", text: "8")
    expect(page).to have_css("tbody tr:nth-child(9) td:nth-child(5)", text: "8")
    expect(page).to have_css("tbody tr:nth-child(9) td:nth-child(6)", text: "4")
    ...
    expect(page).to have_css("tbody tr:nth-child(10) td:nth-child(2)", text: "0")
    ...
    expect(page).to have_css("tbody tr:nth-child(10) td:nth-child(6)", text: "2")
    expect(page).to have_css("tbody tr:nth-child(10) td:nth-child(7)", text: "2")
  end
end
