...
RSpec.feature "Participant validation journey",
  ...
  before do
    ...
    given_i_have_reported_a_mentor mentor_full_name
  ...
  scenario "Mentor validation journey without TRN is accessible" do
    ...
    then_i_am_on_the_mentor_registration_wizard
    and_the_page_is_accessible
  ...
  scenario "Mentor validates their details with trn" do
    ...
    when_i_add_teacher_reference_number_from_mentor_registration_wizard "7654321"
    when_i_add_date_of_birth_from_mentor_registration_wizard Date.new(1991, 11, 4)
    when_i_choose_add_your_national_insurance_number_from_mentor_registration_wizard
    when_i_add_national_insurance_number_from_mentor_registration_wizard "AB123456C"
    when_i_choose_confirm_your_name_from_mentor_registration_wizard
    when_i_choose_last_name_has_changed_from_mentor_registration_wizard
    when_i_add_full_name_from_mentor_registration_wizard "Correct Name"
...
private
  ...
  def given_i_have_reported_an_ect(full_name)
    user = create :user,
                  full_name: full_name

    teacher_profile = create :teacher_profile,
                             user: user
  ...
  def given_i_have_reported_a_mentor(full_name)
    user = create :user,
                  full_name: full_name
