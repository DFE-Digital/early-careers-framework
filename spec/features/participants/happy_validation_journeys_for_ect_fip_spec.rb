...
RSpec.feature "ECT participant validation journey for FIP induction", type: :feature, js: true, rutabaga: false, with_feature_flags: { participant_validation: "active" } do
