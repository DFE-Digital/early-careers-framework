...
RSpec.feature "Unhappy ECT participant validation journeys for FIP induction", type: :feature, js: true, rutabaga: false, with_feature_flags: { participant_validation: "active" } do
