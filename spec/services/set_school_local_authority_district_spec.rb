...
RSpec.describe SetSchoolLocalAuthorityDistrict do
  ...
  describe ".call" do
    ...
    context "when a school local authority record exists" do
      ...
      before do
        SchoolLocalAuthorityDistrict.create!(school:, local_authority_district: old_la_district, start_year: 2020)
      end
    ...
    context "when no matching local authority district exists" do
      ...
      it "raises an exception" do
        expect {
          service.call(school:, administrative_district_code: bad_la_district_code, start_year:)
