    ...
    describe ".training_programme" do
      ...
      context "when mappings are enabled" do
        ...
        context "when training_programme is 'design_our_own'" do
          ...
          it { is_expected.to eq("design_our_own") }
        end

        context "when training_programme is anything else" do
          let(:training_programme) { build(:induction_programme, :anything_else).training_programme }

          it { is_expected.to eq("anything_else") }
        end
      end
