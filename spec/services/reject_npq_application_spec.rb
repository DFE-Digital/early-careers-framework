...
RSpec.shared_examples "validating an application to be rejected" do
...
RSpec.shared_examples "rejecting a npq application" do
...
RSpec.describe RejectNPQApplication, :with_default_schedules do
  let(:npq_application) { create(:npq_application, :accepted) }
  let(:params) do
    {
      npq_application:,
  ...
  describe "#call" do
    ...
    describe "validations" do
      it_behaves_like "validating an application to be rejected"
    end

    describe ".call" do
      it_behaves_like "rejecting a npq application"
    end
  end
end
