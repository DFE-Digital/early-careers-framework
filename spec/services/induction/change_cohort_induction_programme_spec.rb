...
RSpec.describe Induction::ChangeCohortInductionProgramme do
  describe "#call" do
    ...
    let!(:mentor_induction_record) { Induction::Enrol.call(induction_programme:, participant_profile: mentor_profile, start_date: 6.months.ago) }
    ...
    it "changes the programme choice on the school cohort" do
      service.call(school_cohort:, programme_choice:)
