...
RSpec.describe CocSetParticipantCategories3, with_feature_flags: { change_of_circumstances: "active" } do
  describe "#run" do
    ...
    context "SIT for multiple schools" do
      ...
      it "only returns ECTs for the selected school cohort" do
        ect_categories = service.call(school_cohort, induction_coordinator.user).last
      ...
      it "only returns mentors for the selected school cohort" do
        mentor_categories = service.call(school_cohort, induction_coordinator.user).first
