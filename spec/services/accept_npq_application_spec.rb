...
RSpec.shared_examples "validating an application to be accepted" do
...
RSpec.describe AcceptNPQApplication, :with_default_schedules do
  ...
  describe "#call" do
    ...
    describe "validations" do
      it_behaves_like "validating an application to be accepted"
    end
