  ...
  context "event declarations" do
    before do
      10.times do
        ...
        participant_record = create(:participation_record, cpd_lead_provider: cpd_lead_provider)
    ...
    describe ".call" do
      context "aggregate using ParticipationRecorder" do
        it "returns a count of the active participants" do
          expect(described_class.call({ recorder: ParticipationRecord, cpd_lead_provider: cpd_lead_provider })).to eq(10)
        end
      end
