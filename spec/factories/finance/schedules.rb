...
FactoryBot.define do
  factory :schedule, class: "Finance::Schedule" do
    factory :ecf_schedule, class: "Finance::Schedule::ECF" do
    ...
    factory :npq_specialist_schedule, class: "Finance::Schedule::NPQSpecialist" do
      name { "NPQ Specialist November 2021" }
      schedule_identifier { "npq-specialist-november-2021" }
    end

    factory :npq_leadership_schedule, class: "Finance::Schedule::NPQSpecialist" do
