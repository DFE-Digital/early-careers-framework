Feature: Sign In Email
  ...
  Scenario: Login as an Admin User to receive notification with magic link
    ...
    When I type "admin-test@example.com" into "email" field
    Then An email notification should be sent for email "admin-test@example.com"
  ...
  Scenario: Login as an Lead Provider User to receive notification with magic link
    ...
    And I am on "sign in" page
    When I type "lead-provider-test@example.com" into "email" field
