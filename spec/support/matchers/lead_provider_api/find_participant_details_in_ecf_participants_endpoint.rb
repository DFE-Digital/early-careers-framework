...
module Support
  module CanRetrieveParticipantDetailsFromTheEcfParticipantsEndpoint
    ...
    RSpec::Matchers.define :find_participant_details_in_ecf_participants_endpoint do |participant_name, participant_email, participant_trn, school_name, participant_type, participant_status, training_status, _options = {}|
