      ...
      dir.up do
        PrivacyPolicy.create(
          ...
          html: <<~PRIVACY_POLICY,
            ...
            <p class="govuk-body">This means we’re joint data controllers, as well as data processors, for your information (defined
             by data protection law).</p>
            <p class="govuk-body">Manage Training for Early Career Teachers is a new service. We’re confident that it has met our
             security standards, but we’ll continue to run security tests as we improve the service.</p>
            ...
            <ul class="govuk-list govuk-list--bullet">
             ...
             <li>email address</li>
             <li>TRN number</li>
             <li>any other information you choose to share during the applicaiton process - for example, you can choose to share
               equality and diversity information
             </li>
            </ul>
            <h3 class="govuk-heading-s">What data we collect if you work for a training provider</h3>
            <p class="govuk-body">If you process teacher training applications, we may need to collect information about you so we
             can process applications, for example:</p>
            <ul class="govuk-list govuk-list--bullet">
             <li>your name</li>
            ...
            <p class="govuk-body">We do so under section 132 of the Education Act 2002, together with regulation 5 of the Education
             (School Teachers Qualifications) (England) Regulations 2003.</p>
            <h3 class="govuk-heading-s">Sharing data with teacher training providers</h3>
            <p class="govuk-body">We share early career teacher and mentor data with the teacher training providers the candidate
             applies to.</p>
            ...
            <p class="govuk-body">We use a customer service management system to process some personal data, such as feedback you
             send us.</p>
            <p class="govuk-body"><a class="govuk-link govuk-link" href="https://www.zendesk.co.uk/company/customers-partners/master-subscription-agreement/?cta=msa#confidentiality">Zendesk</a>
             is currently our preferred customer service management system because it uses various safeguards to look after your
             data.</p>
            ...
            <p class="govuk-body">We host our services on GOV.UK PaaS, which encrypts your data to prevent it being accessed by
             unauthorised people.</p>

            <h2 class="govuk-heading-m">Your rights</h2>
            <p class="govuk-body">Under the Data Protection Act 2018, you have the right to find out what data we have about you.
             This includes the right to:</p>
            <ul class="govuk-list govuk-list--bullet">
            ...
            <p class="govuk-body">You can find out more about how we handle personal data in
             our <a class="govuk-link govuk-link" href="https://www.gov.uk/government/organisations/department-for-education/about/personal-information-charter">personal information charter.</a></p>

            <h2 class="govuk-heading-m">Getting help and raising a concern</h2>
            <p class="govuk-body">If you want to ask us to remove your data or get access to the data we have about you, you can
             email us on:</p>

            <p><a class="govuk-link govuk-link--no-visited-state" href="mailto:continuing-professional-development@digital.education.gov.uk">continuing-professional-development@digital.education.gov.uk</a>
            </p>

            <p class="govuk-body">You can also use our contact form
             to <a class="govuk-link govuk-link" href="https://form.education.gov.uk/en/AchieveForms/?form_uri=sandbox-publish://AF-Process-f1453496-7d8a-463f-9f33-1da2ac47ed76/AF-Stage-1e64d4cc-25fb-499a-a8d7-74e98203ac00/definition.json&amp;redirectlink=%2Fen&amp;cancelRedirectLink=%2Fen">get in touch with our Data Protection Officer.</a></p>
            ...
            <p class="govuk-body">For further information or to raise a concern, visit
             the <a class="govuk-link" href="https://ico.org.uk/">Information Commissioner&#39;s Office.</a></p>
            ...
            <p class="govuk-body">We reserve the right to update this privacy notice at any time, and we will provide you with a new
             privacy notice when we make any substantial updates. We will also notify you in other ways from time to time about the
