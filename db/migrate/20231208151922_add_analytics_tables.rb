...
class AddAnalyticsTables < ActiveRecord::Migration[7.0]
  def change
    create_table "ecf_appropriate_bodies", id: :uuid, default: -> { "gen_random_uuid()" } do |t|
    ...
    create_table "ecf_inductions", id: :uuid, default: -> { "gen_random_uuid()" } do |t|
      ...
      t.index ["induction_record_id"], name: "index_ecf_inductions_on_induction_record_id", unique: true # rubocop:disable Style/WordArray
    end

    create_table "ecf_participants", id: :uuid, default: -> { "gen_random_uuid()" } do |t|
      t.string "user_id"
      ...
      t.string "external_id"
      t.index ["participant_profile_id"], name: "index_ecf_participants_on_participant_profile_id" # rubocop:disable Style/WordArray
    end

    create_table "ecf_partnerships", id: :uuid, default: -> { "gen_random_uuid()" } do |t|
      t.uuid "partnership_id"
      t.uuid "school_id"
      t.string "school_name"
      t.string "school_urn"
    ...
    create_table "ecf_school_cohorts", id: :uuid, default: -> { "gen_random_uuid()" } do |t|
    ...
    create_table "ecf_schools", id: :uuid, default: -> { "gen_random_uuid()" } do |t| # rubocop:disable Rails/CreateTableWithTimestamps
      t.string "name"
      t.string "urn"
      ...
      t.boolean "pupil_premium"
      t.boolean "sparsity"
      t.index ["urn"], name: "index_ecf_schools_on_urn", unique: true # rubocop:disable Style/WordArray
    end
  end
end
