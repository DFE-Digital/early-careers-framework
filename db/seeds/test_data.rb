...
# NPQ contracts
NPQLeadProvider.all.each do |cpd_lead_provider|
  npq_specifics.each do |npq_contract|
    attributes = npq_contract.merge(npq_lead_provider: cpd_lead_provider)
...
npq_profile = ParticipantProfile::NPQ.find_or_create_by!(teacher_profile: teacher_profile, schedule: Finance::Schedule::NPQSpecialist.default)
