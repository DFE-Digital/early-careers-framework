...
WHERE participant_profiles.participant_identity_id IN (SELECT participant_identity_id FROM participant_profiles GROUP BY participant_identity_id HAVING COUNT(*) > 1)
