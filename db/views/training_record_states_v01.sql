        ...
        SELECT
            ...
            CASE
                ...
                WHEN "participant_profiles"."type" = 'ParticipantProfile::Mentor'
                    THEN
                    CASE
                        WHEN "mentee_counts"."total" > 0 AND "induction_programmes"."training_programme" = 'full_induction_programme' AND "partnerships"."lead_provider_id" IS NULL
                ...
                WHEN "participant_profiles"."type" = 'ParticipantProfile::Mentor'
                    ...
                    CASE
                        WHEN "induction_programmes"."training_programme" = 'full_induction_programme'
                            THEN
                            CASE
                                WHEN "mentee_counts"."total" > 0 AND "partnerships"."lead_provider_id" IS NULL
                                    THEN 'active_fip_mentoring_no_partner'
                                WHEN "mentee_counts"."total" > 0 AND "ecf_participant_eligibilities"."reason" = 'previous_participation'
...
SELECT
    ...
    CASE
        WHEN "individual_training_record_states"."training_state" IN ('withdrawn_programme', 'withdrawn_training', 'deferred_training', 'completed_training', 'leaving', 'left')
        ...
        WHEN NOT ("individual_training_record_states"."training_eligibility_state" IN ('eligible_for_mentor_training', 'eligible_for_mentor_training_no_partner', 'eligible_for_induction_training', 'eligible_for_induction_training_no_partner', 'not_yet_mentoring'))
            THEN "individual_training_record_states"."training_eligibility_state"
        WHEN "individual_training_record_states"."training_programme" = 'full_induction_programme' AND NOT ("individual_training_record_states"."fip_funding_eligibility_state" IN ('eligible_for_mentor_funding', 'eligible_for_mentor_funding_primary', 'eligible_for_fip_funding'))
