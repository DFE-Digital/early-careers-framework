...
FactoryBot.create(:seed_induction_coordinator_profile, :with_user).tap do |induction_coordinator_profile|
  ...
  mentor_jan = NewSeeds::Scenarios::Participants::Mentors::MentorWithNoEcts
    ...
    .build(teacher_profile_args: { trn: "7654321" })
    .with_validation_data(full_name: "Jan Tracey", date_of_birth: Date.new(1960, 2, 1))
    .with_eligibility
  ...
  mentor_marcy = NewSeeds::Scenarios::Participants::Mentors::MentorWithNoEcts
    ...
    .build(teacher_profile_args: { trn: "5471234" })
    .with_validation_data(full_name: "Marcy Erna", date_of_birth: Date.new(1970, 2, 1))
    .with_eligibility
    .with_induction_record(induction_programme: ur_induction_programme_2022, appropriate_body: fhtsh_ab)
    .participant_profile
  ...
  mentor_hayate = NewSeeds::Scenarios::Participants::Mentors::MentorWithNoEcts
    ...
    .build(teacher_profile_args: { trn: "2468101" })
    .with_validation_data(full_name: "Hayate Jannat", date_of_birth: Date.new(1990, 2, 1))
    .with_eligibility
    .with_induction_record(induction_programme: ur_induction_programme_2022, appropriate_body: fhtsh_ab)
    .participant_profile
  ...
  NewSeeds::Scenarios::Participants::Mentors::MentorWithNoEcts
    ...
    .build(teacher_profile_args: { trn: "3456789" })
    .with_validation_data(full_name: "Nandita Carla", date_of_birth: Date.new(1995, 2, 1))
    .with_eligibility
    .with_induction_record(induction_programme: ur_induction_programme_2022, appropriate_body: fhtsh_ab)
    .participant_profile

  NewSeeds::Scenarios::Participants::Ects::Ect
    .new(school_cohort: ur_school_cohort_2022, full_name: "Susanna Pelo", email: "Susanna.Pelo@school.com")
    .build(induction_start_date: Date.new(2022, 9, 5),
           mentor_profile: mentor_jan,
           teacher_profile_args: { trn: "1234567" })
    .tap do |ect|
    ect.with_eligibility(qts: false, reason: "no_qts", status: "manual_check")
    ect.with_validation_data(full_name: "Susanna Pelo", date_of_birth: Date.new(2000, 2, 1))
  ...
  NewSeeds::Scenarios::Participants::Ects::Ect
    .new(school_cohort: ur_school_cohort_2022, full_name: "Memet Jacob", email: "Memet.Jacob@school.com")
    .build(induction_start_date: Date.new(2022, 9, 5),
           mentor_profile: mentor_marcy,
           teacher_profile_args: { trn: "8910111" })
    .tap do |ect|
    ect.with_eligibility
    ect.with_validation_data(full_name: "Memet Jacob", date_of_birth: Date.new(1980, 2, 1))
    ect.with_induction_record(induction_programme: ur_induction_programme_2022,
                              mentor_profile: mentor_marcy,
                              appropriate_body: fhtsh_ab)
  end
  ...
  NewSeeds::Scenarios::Participants::Ects::Ect
    .new(school_cohort: ur_school_cohort_2021, full_name: "Keisha Edwina", email: "Keisha.Edwina@school.com")
    .build(induction_start_date: Date.new(2021, 9, 5),
           mentor_profile: mentor_hayate,
           teacher_profile_args: { trn: "1617181" })
    .tap do |ect|
    ect.with_eligibility
    ect.with_validation_data(full_name: "Keisha Edwina", date_of_birth: Date.new(1995, 2, 1))
  ...
  NewSeeds::Scenarios::Participants::Ects::Ect
    .new(school_cohort: ur_school_cohort_2022, full_name: "Laurence Firoozeh", email: "Laurence.Firoozeh@school.com")
    .build(induction_start_date: Date.new(2022, 9, 5),
           mentor_profile: mentor_jan,
           teacher_profile_args: { trn: "9202122" })
    .tap do |ect|
    ect.with_eligibility
    ect.with_validation_data(full_name: "Laurence Firoozeh", date_of_birth: Date.new(2002, 2, 1))
    ect.with_induction_record(induction_programme: ur_induction_programme_2021,
                              mentor_profile: mentor_jan,
                              appropriate_body: nta_ab)
  end
  ...
  NewSeeds::Scenarios::Participants::Ects::Ect
    .new(school_cohort: ur_school_cohort_2022, full_name: "Kirsty Alexandra", email: "Kirsty.Alexandra@school.com")
    .build(induction_start_date: Date.new(2022, 4, 5),
           mentor_profile: mentor_marcy,
           teacher_profile_args: { trn: "2324252" })
    .tap do |ect|
    ect.with_eligibility
    ect.with_validation_data(full_name: "Kirsty Alexandra", date_of_birth: Date.new(1985, 2, 1))
    ect.with_induction_record(induction_programme: ur_induction_programme_2021,
                              mentor_profile: mentor_marcy,
                              appropriate_body: nta_ab)
  end
  ...
  NewSeeds::Scenarios::Participants::Ects::Ect
    .new(school_cohort: ur_school_cohort_2022, full_name: "Emmanuel Takumi", email: "Emmanuel.Takumi@school.com")
    .build(induction_start_date: Date.new(2023, 1, 1),
           mentor_profile: mentor_hayate,
           teacher_profile_args: { trn: "3031323" })
    .tap do |ect|
    ect.with_eligibility
    ect.with_validation_data(full_name: "Emmanuel Takumi", date_of_birth: Date.new(1998, 2, 1))
    ect.with_induction_record(induction_programme: ur_induction_programme_2022,
  ...
  NewSeeds::Scenarios::Participants::Ects::Ect
    .new(school_cohort: ur_school_cohort_2022, full_name: "Mel Jackson", email: "Mel.Jackson@school.com")
    .build(induction_start_date: Date.new(2023, 1, 1),
           teacher_profile_args: { trn: "5031020" })
    .tap do |ect|
    ect.with_eligibility
    ect.with_validation_data(full_name: "Mel Jackson", date_of_birth: Date.new(1998, 2, 1))
    ect.with_induction_record(induction_programme: ur_induction_programme_2022,
                              appropriate_body: fhtsh_ab)
  end
end
