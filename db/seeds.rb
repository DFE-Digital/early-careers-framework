...
unless Network.first
  ...
  School.create!(urn: "TEST_URN_1", name: "Test school one", address_line1: "Test address", country: "England", postcode: "TEST1", network: network, school_domains: [SchoolDomain.create(domain: "testschool1.sch.uk")])
  School.create!(urn: "TEST_URN_2", name: "Test school two", address_line1: "Test address London", country: "England", postcode: "TEST2", school_domains: [SchoolDomain.create(domain: "testschool2.sch.uk")])
