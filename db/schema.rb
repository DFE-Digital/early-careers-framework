...
ActiveRecord::Schema[7.1].define(version: 2025_01_06_133003) do
  ...
  create_table "mentors_call_off_contracts", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.uuid "lead_provider_id", null: false
    t.uuid "cohort_id", null: false
    t.string "version", default: "0.0.1", null: false
    t.integer "recruitment_target"
    t.decimal "payment_per_participant", default: "1000.0"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["cohort_id"], name: "index_mentors_call_off_contracts_on_cohort_id"
    t.index ["lead_provider_id"], name: "index_mentors_call_off_contracts_on_lead_provider_id"
  end
  ...
  add_foreign_key "mentors_call_off_contracts", "cohorts"
  add_foreign_key "mentors_call_off_contracts", "lead_providers"
